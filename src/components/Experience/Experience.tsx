...
const Experience: React.FC = () => {
    return (
        ...
        <div className={styles.container}>
          <h3 className={styles.experience_h} data-i18n="navExperienceH">Мій досвід</h3>
          <div className={styles.experience_right}>
            <div className={styles.experience_right_top}>
              ...
              <p
                className={styles.experience_p_two}
                data-i18n="navExperiencePtwo"
              >
                2024 — теперішній час
              </p>
            </div>
            <p
              className={styles.experience_p_two_two}
              data-i18n="navExperiencePthree"
            >
            ...
            <div className={styles.experience_right_down}>
              <p
                className={styles.experience_p_three}
                data-i18n="navExperiencePfour"
              >
                Курси та онлайн-навчання
              </p>
              <p
                className={styles.experience_p_four_four}
                data-i18n="navExperiencePsix"
              >
                2024 — теперішній час
              </p>
            </div>
            <p
              className={styles.experience_p_five}
              data-i18n="navExperiencePseven"
            >
              Самоосвіта
            </p>
            <p
              className={styles.experience_p_two}
              data-i18n="navExperiencePeight"
            >
